import './index.scss'
import LogoG from '../../../assets/images/logo-gris.png'
...
const Logo = () => {
    ...
    return (
        <div className="logo-container" ref={bgRef}>
            <img ref={solidLogoRef} className="solid-logo" src={LogoG} alt="logo" />
            <svg
                version="1.0"
                xmlns="http://www.w3.org/2000/svg"
                width="492.000000pt"
                height="501.000000pt"
                viewBox="0 0 492.000000 501.000000"
            ...
            >
                <g
                    ...
                    stroke="none"
                >
                    <path ref={(el) => (outlineLogoRefs.current[0] = el)}
                        d="M2325 4830 c-323 -36 -633 -138 -900 -295 -336 -198 -631 -500 -815
...
-117 288 -37 138 -56 290 -55 430 l0 124 18 -67 c10 -36 26 -86 35 -110z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[1] = el)}
                        d="M3788 4435 c-9 -21 -8 -28 7 -45 24 -27 51 -25 70 4 23 34 5 66 -36
66 -22 0 -32 -6 -41 -25z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[2] = el)}
                        d="M4080 4189 c-9 -16 -8 -26 5 -45 19 -29 46 -31 70 -4 15 17 16 24 7
45 -15 32 -66 35 -82 4z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[3] = el)}
                        d="M4338 3909 c-27 -15 -24 -67 5 -78 46 -18 86 38 52 73 -19 18 -33 20
-57 5z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[4] = el)}
                        d="M4546 3503 c115 -267 170 -515 181 -803 14 -401 -84 -802 -277 -1142
-33 -58 -48 -94 -42 -100 20 -20 155 243 222 432 87 242 123 461 123 740 0
339 -62 624 -200 921 -74 159 -80 119 -7 -48z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[5] = el)}
                        d="M3450 3354 c-286 -55 -474 -315 -433 -600 29 -204 183 -376 392 -438
...
173 101 317 98 98 -2 110 -5 181 -38z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[6] = el)}
                        d="M1290 2832 c0 -456 2 -511 16 -516 9 -3 67 -6 130 -6 l114 0 0 84 0
...
252 4 464 7 472 4 10 45 12 213 10 l207 -4 66 -32z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[7] = el)}
                        d="M1490 2925 c0 -278 -10 -259 139 -253 115 4 168 28 216 96 28 41 30
...
-18 0 6 5 11 10 11 6 0 10 70 10 190 l0 190 84 0 c70 0 88 -4 116 -23z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[8] = el)}
                        d="M2180 2831 c0 -455 2 -510 16 -515 9 -3 65 -6 125 -6 l109 0 0 74 0
...
c-49 0 -82 3 -75 6 9 4 12 107 12 470 l0 465 208 -3 c204 -4 208 -5 265 -33z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[9] = el)}
                        d="M2380 2912 c0 -219 2 -251 16 -256 9 -3 57 -6 107 -6 107 0 155 17
...
-36 -10 -146 -10 -149 0 -2 4 -3 97 -3 207 l0 200 85 0 c81 0 86 -1 121 -32z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[10] = el)}
                        d="M3855 1696 c-5 -2 -46 -11 -90 -20 -44 -9 -111 -22 -150 -30 -38 -8
...
-5 5 -8 10 -19 10 -25z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[11] = el)}
                        d="M3878 1655 c-3 -4 -39 -12 -79 -20 -41 -7 -128 -25 -194 -40 -205
...
269 55 305 61 36 6 85 17 110 24 58 16 60 16 64 2z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[12] = el)}
                        d="M3694 1457 c-73 -94 -131 -180 -223 -331 -102 -167 -120 -212 -36
-91 30 44 64 94 75 110 60 87 230 350 230 357 0 13 -3 10 -46 -45z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[13] = el)}
                        d="M3332 1385 c-104 -125 -281 -389 -269 -401 8 -9 67 71 247 340 8 12
37 50 64 85 77 99 46 82 -42 -24z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[14] = el)}
                        d="M3149 1313 c-34 -38 -53 -63 -46 -63 2 0 21 20 41 45 41 50 44 61 5
18z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[15] = el)}
                        d="M3777 1293 c-57 -79 -147 -230 -130 -220 19 12 181 267 170 267 -3 0
-21 -21 -40 -47z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[16] = el)}
                        d="M3842 1201 c-34 -43 -42 -62 -17 -41 22 18 58 70 53 76 -3 2 -19 -14
-36 -35z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[17] = el)}
                        d="M4150 724 c-8 -3 -40 -16 -70 -29 -30 -12 -74 -31 -98 -41 -23 -9
...
9 49 20 87 40 140 57 155 49 8 -4 45 -27 81 -51z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[18] = el)}
                        d="M4084 635 c-23 -21 -24 -24 -4 -11 28 18 44 21 35 6 -4 -6 7 -10 27
...
40 50 -9 102 -106 111 -54 5 -62 3 -89 -22z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[19] = el)}
                        d="M3809 525 c-3 -2 -65 -11 -139 -20 -129 -15 -255 -34 -515 -75 -66
...
-1 12 8 0 12 12 19 41 25 4 0 10 -6 13 -15z"
                    />
                    <path ref={(el) => (outlineLogoRefs.current[20] = el)}
                        d="M3350 319 c0 -5 5 -7 10 -4 6 3 10 8 10 11 0 2 -4 4 -10 4 -5 0 -10
-5 -10 -11z"
                    />
                </g>
            </svg>
